...
EMP_BUILD_CONFIG( L9ChgEnvConfig,
  ...
  VALUE(ENVIRONMENT_DISTRACTION_SIGNALS, size_t, 8, "How many distraction signals?"),
  ...
  VALUE(MAP_ELITES_AXIS_RES__INST_ENTROPY, double, 25, "Resolution of entropy axis in map elites"),
  VALUE(MAP_ELITES_AXIS_RES__SIMILARITY_THRESH, double, 5, "Resolution of similarity threshold in map elites"),
