...
EMP_BUILD_CONFIG( PatternMatchingConfig,
  ...
  VALUE(DEME_PROP_CLUMPY, bool, false, "If true, the propagules are clumped; otherwise, the propagules are randomly distributed."),
  ...
  VALUE(PER_INST__SUB_RATE, double, 0.005, "Per-instruction substitution mutation rate."),
