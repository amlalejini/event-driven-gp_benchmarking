...
EMP_BUILD_CONFIG( LogicOperationsConfig,
  ...
  VALUE(ENVIRONMENT_FALSE_SIGNALS, size_t, 0, "Should (and how many) the environment randomly generate false change signals?"),
  VALUE(ENVIRONMENT_FALSE_SIGNAL_PROB, double, 0.125, "Probability of a random false signal each update during evaluation."),
  GROUP(HARDWARE_GROUP, "Hardware Settings."),
  VALUE(ENV_SIGNALS, bool, true, "True: event-driven hardware; False: imperative hardware."),
  ...
  VALUE(PER_INST__INS_RATE, double, 0.005, ""),
  VALUE(PER_INST__DEL_RATE, double, 0.005, ""),
